...
<div class="container">
    <form action="Emailsend.php" method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control color" id="name" name="name" placeholder="Name">
        </div>
        <div class="mb-3">
            <label for="email" class="form-label">Email address</label>
            <input type="email" name="email" class="form-control color" id="email" placeholder="Email">
        </div>
        <div class="mb-3">
            <label for="message" class="form-label">Message</label>
            <textarea class="form-control color" name="message" id="message" rows="3" placeholder="Message"></textarea>
        </div>
        <input type="submit" class="btn color" name="submit" value="Submit">
    </form>
</div>
